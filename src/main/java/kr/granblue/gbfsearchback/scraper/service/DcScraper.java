...
import kr.granblue.gbfsearchback.scraper.dto.DcBoardsAndComments;
import kr.granblue.gbfsearchback.scraper.dto.ScrapeRequest;
...
public interface DcScraper {
     ...
     * @param webDriver
     * @see kr.granblue.gbfsearchback.scraper.util.WebDriverUtil
     */
    ...
    /**
     * 스크래핑 옵션을 설정합니다.
     * @see kr.granblue.gbfsearchback.scraper.enums.ScrapingOption
